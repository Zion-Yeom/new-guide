(function(global, factory) {
  typeof exports === "object" && typeof module !== "undefined" ? factory(exports, require("vue")) : typeof define === "function" && define.amd ? define(["exports", "vue"], factory) : (global = typeof globalThis !== "undefined" ? globalThis : global || self, factory(global.vrix = {}, global.Vue));
 ...
 */
  ...
  class ComponentWrapper {
    ...
    destroy() {
      vue.render(null, this.wrapper.container);
    }
  ...
  function factory(host, type, wrapperClass) {
    ...
    const create = (args) => {
      ...
      const vnode = vue.createVNode(type, data, { ...instance.slots });
  ...
  function useRender(render2) {
    vue.getCurrentInstance().render = render2;
  }
  const VxListItem = vue.defineComponent({
    name: "VxListItem",
    props: {
      ...makeItemProps()
    },
    setup(props, context) {
      const provider = vue.inject(VxListSymbol);
      const label = vue.computed(() => provider.itemToLabel(state.value.item));
      const state = vue.ref(props.initState);
      useRender(() => {
        const children = [];
  ...
  class ItemTemplateWrapper extends ComponentWrapper {
    ...
    onUpdated(hook) {
      this.releaseOnUpdate = vue.onUpdated(hook, this.instance["_"]);
    }
    onMounted(hook) {
      this.releaseOnMount = vue.onMounted(hook, this.instance["_"]);
    }
    prepare(state) {
      var _a;
  ...
  const VxListImpl = vue.defineComponent({
    name: "VxList",
    ...
    setup(props) {
      ...
      useRender(() => vue.h("div", { class: "x-list-wrap" }));
      vue.provide(VxListSymbol, {
        list: nativeInstance,
        itemToLabel: (item) => {
  ...
  const VxTreeItem = vue.defineComponent({
    name: "VxTreeItem",
    props: {
      ...makeItemProps()
    },
    setup(props, context) {
      const provider = vue.inject(VxTreeSymbol);
      const state = vue.ref(props.initState);
      const label = vue.computed(() => provider.itemToLabel(state.value.item));
      ...
      useRender(() => {
        ...
        if (context.slots.default && state.value) {
          ...
          const toggleNode = vue.h(
            ...
            [vue.h("i", { class: "x-toggle-icon" })]
          );
          const labelNode = vue.h(
            "div",
            {
              class: "x-label"
            },
  ...
  const VxTreeImpl = vue.defineComponent({
    name: "VxTree",
    ...
    setup(props) {
      ...
      useSelectableModels(props, nativeInstance);
      useRender(() => vue.h("div", { class: "x-tree-wrap" }));
      vue.provide(VxTreeSymbol, {
        list: nativeInstance,
        itemToLabel: (item) => {
          if (item == null || typeof item !== "object") {
            return item;
  ...
  const VxPopupImpl = vue.defineComponent({
    name: "VxPopup",
    ...
    setup(props, context) {
      ...
      vue.provide(VxPopupSymbol, nativeInstance);
      useRender(() => {
        if (!props.usePreRender && !isFirst.value) {
          return vue.h("template");
        }
        return vue.h("template", context.slots.default());
      });
  ...
  const VxSuggestItem = {
    ...
    setup(props) {
      const state = vue.reactive(props.initState);
      return {
        state
      };
    },
    ...
    render() {
      return vue.h("div", this.genContent());
    },
    prepare(state) {
  ...
  const VxSuggestStatus = vue.defineComponent({
    ...
    setup(props, context) {
      ...
      const provider = vue.inject(VxAutocompleteSymbol);
      useRender(() => {
        return vue.h("div", slot(provider.inputValue.value));
      });
    }
  });
  ...
  const VxAutocompleteImpl = vue.defineComponent({
    name: "VxAutocomplete",
    props: {
      ...defaultInputProps,
      ...defaultSuggestProps,
    ...
    setup(props) {
      ...
      useModel(props, "selectedItem", nativeInstance, "selectedItem", "selection-change");
      useRender(() => vue.h("div", { class: "x-autocomplete-wrap" }));
      vue.provide(VxAutocompleteSymbol, {
  ...
  const VxChip = vue.defineComponent({
    name: "VxChip",
    props: {
      item: {
    ...
    methods: {
      genLabel() {
        return vue.h("span", { class: "x-label" }, this.slotProps.label);
      },
      genRemover() {
        return vue.h("button", {
          class: "x-remover",
    ...
    render() {
      return vue.h("div", { class: "x-select-chip" }, this.genContent());
    }
  });
  ...
  const VxTokenizerImpl = vue.defineComponent({
    name: "VxTokenizer",
    ...
    setup(props) {
      ...
      useSelectableModels(props, nativeInstance);
      useRender(() => vue.h("div", { class: "x-tokenizer-wrap" }));
      vue.provide(VxAutocompleteSymbol, {
        instance: nativeInstance,
        get inputValue() {
          return inputValue;
  ...
  const VxTextChip = vue.defineComponent({
    name: "VxTextChip",
    props: {
      item: {
        type: [String, Number, Object]
    ...
    setup(props) {
      const label = vue.computed(() => props.nativeInstance.itemToLabel(props.item));
      return {
        label
      };
    },
    methods: {
      genLabel() {
        return vue.h("span", { class: "x-label" }, this.label);
      },
      genContent() {
        if (this.item) {
          if (this.$slots.chip) {
    ...
    render() {
      return vue.h("div", { class: "x-select-text" }, this.genContent());
    }
  });
  ...
  const VxComboboxImpl = vue.defineComponent({
    name: "VxCombobox",
    emits: [...NativeTokenizerEvents, "update:modelValue", "update:selectedItem", "update:selectedItems", "update:selectedValue", "update:inputValue"],
    props: {
      ...defaultInputProps,
    ...
    render() {
      return vue.h("div", { class: "x-combobox-wrap" });
    }
  });
  const VxCombobox = VxComboboxImpl;
  const VxDateChooserItem = vue.defineComponent({
  ...
  const VxDateChooserImpl = vue.defineComponent({
    name: "VxDateChooser",
    ...
    setup(props) {
      ...
      vue.provide(VxDateChooserSymbol, {});
      return {
        nativeInstance,
        getState() {
    ...
    render() {
      return vue.h("div", { class: "x-date-chooser-wrap" });
    }
  });
  ...
  const VxDatePickerImpl = vue.defineComponent({
    name: "VxDatePicker",
    props: {
      ...defaultDateChooserProps,
    ...
    setup(props) {
      ...
      vue.provide(VxDatePickerSymbol, {});
      return {
        nativeInstance,
        clear() {
    ...
    render() {
      return vue.h("div", { class: "x-date-picker-wrap" });
    }
  });
  ...
  exports2.Combobox = Combobox;
  exports2.DateChooser = DateChooser;
  exports2.DatePicker = DatePicker;
  exports2.DragManager = DragManager;
  exports2.HierarchyList = HierarchyList;
  exports2.List = List;
  exports2.Popup = Popup;
  exports2.ProgressPromise = ProgressPromise;
  exports2.Tokenizer = Tokenizer;
  exports2.Tree = Tree;
  exports2.VxAutocomplete = VxAutocomplete;
  exports2.VxAutocompleteSymbol = VxAutocompleteSymbol;
  exports2.VxCombobox = VxCombobox;
  exports2.VxComboboxSymbol = VxComboboxSymbol;
  exports2.VxDateChooser = VxDateChooser;
  exports2.VxDateChooserSymbol = VxDateChooserSymbol;
  exports2.VxDatePicker = VxDatePicker;
  exports2.VxDatePickerSymbol = VxDatePickerSymbol;
  exports2.VxList = VxList;
  exports2.VxListSymbol = VxListSymbol;
  exports2.VxPopup = VxPopup;
  exports2.VxPopupSymbol = VxPopupSymbol;
  exports2.VxTokenizer = VxTokenizer;
  exports2.VxTokenizerSymbol = VxTokenizerSymbol;
  exports2.VxTree = VxTree;
  exports2.VxTreeSymbol = VxTreeSymbol;
  exports2.default = install;
  Object.defineProperties(exports2, { __esModule: { value: true }, [Symbol.toStringTag]: { value: "Module" } });
});
//# sourceMappingURL=vrix.vue.umd.js.map
